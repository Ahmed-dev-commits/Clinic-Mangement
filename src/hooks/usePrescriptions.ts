...
function dtoToPrescription(dto: PrescriptionDTO): Prescription {
  return {
    ...
    ultrasoundReport: dto.UltrasoundReport,
    examAtHospital: dto.ExamAtHospital,
    examAtHome: dto.ExamAtHome,
  ...
  const addPrescription = async (prescriptionData: Omit<Prescription, 'id' | 'createdAt'>) => {
    ...
    try {
      await prescriptionsApi.create({
        ...
        ultrasoundReport: prescriptionData.ultrasoundReport,
        examAtHospital: prescriptionData.examAtHospital,
        examAtHome: prescriptionData.examAtHome,
